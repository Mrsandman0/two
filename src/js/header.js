        ...
        if (getScrollOffset().y >= scrollTop) {
            ...
            if (getScrollOffset().y <= $('.rush_center').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(0).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
            //第二层
            if (getScrollOffset().y >= $('.rush_center').offset().top && getScrollOffset().y <= $('#writer').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(1).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
            //第三层
            if (getScrollOffset().y >= $('#writer').offset().top && getScrollOffset().y <= $('#hotpush').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(2).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
            //第四层
            if (getScrollOffset().y >= $('#hotpush').offset().top && getScrollOffset().y <= $('#boku').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(3).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
            //第五层
            if (getScrollOffset().y >= $('#boku').offset().top && getScrollOffset().y <= $('#tushu').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(4).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
            //第六层
            if (getScrollOffset().y >= $('#tushu').offset().top && getScrollOffset().y <= $('#tongshu').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(5).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
            //第七层
            if (getScrollOffset().y >= $('#tongshu').offset().top && getScrollOffset().y <= $('#fenlei').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(6).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
            //第八层
            if (getScrollOffset().y >= $('#fenlei').offset().top && getScrollOffset().y <= $('#wenchuang').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(7).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
            //第九层
            if (getScrollOffset().y >= $('#wenchuang').offset().top && getScrollOffset().y <= $('#meixue').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(8).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
            //第十层
            if (getScrollOffset().y >= $('#meixue').offset().top && getScrollOffset().y <= $('#yingyin').offset().top) {
                $('.leftmenu>ul>li').css('background', '#fff')
                    .css('color', '#212121');
                $('.leftmenu>ul>li').eq(9).css('background', '#2DB4EA')
                    .css('color', '#fff');
            }
        } else {
                                ...
                                <ul>
                                    ...
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[0]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[0]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[1]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[1]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[2]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[2]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[3]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[3]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[4]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[4]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[5]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[5]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[6]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[6]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[7]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[7]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[8]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[8]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li class="hotpush_list">
                                        ...
                                        <div class="word">
                                            ...
                                            <p>
                                                <span>¥${arr.datalist[9]['gnewprice']}</span>
                                                <del> |¥${arr.datalist[9]['goldprice']}</del>
                                            </p>
                                        </div>
                                    </li>
                                    <li>
